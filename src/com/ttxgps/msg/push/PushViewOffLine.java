...
public class PushViewOffLine extends PushView implements OnClickListener {
	private Button btnCancel;
	private Button btnConfir;
	private View mRootView;
	private TextView tvMsg;

	public PushViewOffLine(Activity context, PushViewType type) {
		super(context, type);
	}
	...
	protected void onShow(String content) {
		...
		this.btnCancel.setText(R.string.my_exit);
